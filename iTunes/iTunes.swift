...
@objc public protocol iTunesGenericMethods {
    ...
    optional func save() // Save the specified object(s)
...
@objc public protocol iTunesApplication: SBApplicationProtocol {
    ...
    optional func miniplayerWindows() -> SBElementArray
    optional func playlistWindows() -> SBElementArray
    optional func sources() -> SBElementArray
    optional func videoWindows() -> SBElementArray
    ...
    optional var shuffleEnabled: Bool { get } // are songs played in random order?
    optional var shuffleMode: iTunesEShM { get } // the playback shuffle mode
    optional var songRepeat: iTunesERpt { get } // the playback repeat mode
    ...
    optional func setShuffleEnabled(shuffleEnabled: Bool) // are songs played in random order?
    optional func setShuffleMode(shuffleMode: iTunesEShM) // the playback shuffle mode
    optional func setSongRepeat(songRepeat: iTunesERpt) // the playback repeat mode
...
@objc public protocol iTunesItem: SBObjectProtocol, iTunesGenericMethods {
    ...
    optional func download() // download a cloud track or playlist, or a podcast episode
...
@objc public protocol iTunesPlaylist: iTunesItem {
    ...
    optional var objectDescription: String { get } // the description of the playlist
    ...
    optional func setObjectDescription(objectDescription: String!) // the description of the playlist
...
@objc public protocol iTunesSource: iTunesItem {
    ...
    optional func subscriptionPlaylists() -> SBElementArray
...
@objc public protocol iTunesTrack: iTunesItem {
    ...
    optional var cloudStatus: iTunesEClS { get } // the iCloud status of the track
    ...
    optional var downloaderAppleID: String { get } // the Apple ID of the person who downloaded this track
    optional var downloaderName: String { get } // the name of the person who downloaded this track
    ...
    optional var mediaKind: iTunesEMdK { get } // the media kind of the track
    ...
    optional var purchaserAppleID: String { get } // the Apple ID of the person who purchased this track
    optional var purchaserName: String { get } // the name of the person who purchased this track
    ...
    optional func setMediaKind(mediaKind: iTunesEMdK) // the media kind of the track
...
@objc public protocol iTunesWindow: iTunesItem {
    ...
    optional var collapseable: Bool { get } // does the window have a collapse button?
    optional var collapsed: Bool { get } // is the window collapsed?
    optional var fullScreen: Bool { get } // is the window full screen?
    ...
    optional func setFullScreen(fullScreen: Bool) // is the window full screen?
